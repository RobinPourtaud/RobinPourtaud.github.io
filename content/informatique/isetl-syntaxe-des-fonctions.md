...
On appelle produit cartésien de 2 ensembles $e\_1$ et $e\_2$, l'ensemble des couples (i,j) tel que $i\\in e\_1$ et $j\\in e\_2$ .

Si $e\_1 = \\{x,y\\}$ et $e\_2 = \\{1,2\\}$, alors $e\_1\\times e\_2 = \\{(x,1);(x,2);(y,1);(y,2)\\}$.
