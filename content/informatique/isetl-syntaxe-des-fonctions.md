...
On appelle produit cartésien de 2 ensembles {{< latex "e_1" >}} et {{< latex "e_2" >}}, l'ensemble des couples (i,j) tel que {{< latex "i\in e_1" >}} et {{< latex "j\in e_2" >}} .

Si {{< latex "e_1 = \{x,y\}" >}} et {{< latex "e_2 = \{1,2\}" >}}, alors {{< latex "e_1\times e_2 = \{(x,1);(x,2);(y,1);(y,2)\}" >}}.
