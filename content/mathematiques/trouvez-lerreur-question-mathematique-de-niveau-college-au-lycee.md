...
4. $x\_{1,2} = \\frac{1\\pm\\sqrt{49}}{6}$
5. $x\_{1,2}=\\{-1,\\frac{4}{3}\\}$
...
$\\lim\\limits\_{\\substack{n \\to \\infty}}(1+\\frac{1}{n})^n$

Comme $\\lim\\limits\_{\\substack{n \\to \\infty}} (1 + \\frac{1}{n}) = 1$

Et : $\\lim\\limits\_{\\substack{n \\to \\infty}} n = \\infty$

$\\lim\\limits\_{\\substack{n \\to \\infty}}(1+\\frac{1}{n})^n = 1^\\infty = 1$
...
$\\lim\\limits\_{\\substack{n \\to \\infty}}(1+\\frac{1}{n})^n = e$
...
- [https://fr.wikipedia.org/wiki/D%C3%A9veloppement\_limit%C3%A9](https://fr.wikipedia.org/wiki/D%C3%A9veloppement_limit%C3%A9)
