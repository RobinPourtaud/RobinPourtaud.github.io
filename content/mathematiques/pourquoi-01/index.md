...
tags: 
  - "denombrement"
description: "3 factoriel est égal à 1 fois 2 fois 3, 2 factoriel est égal à 1 fois 2, 1 factoriel est égal à 1. En suivant cette logique, pourquoi 0 factoriel ne serait pas égal à rien, soit 0 ? C'est ce qu'on va essayer de comprendre à travers cet article."
---
...
On sait que : $\forall n \in \mathbb{N}^\* : \Gamma(n) = (n–1)!=\int_0^{+\infty} t^{n-1} \times e^{-t}dt$
