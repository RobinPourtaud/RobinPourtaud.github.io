...
$$\int e^{i \ln{x}} = \int \cos{\ln{x}}+ i \times \sin{\ln{x}} dx = \int \cos{\ln{x}} dx+ i \times \int\sin{\ln{x}} dx$$
...
$$\int \cos{u}e^u du = e^u \cos{u} + e^u \sin{u} - \int \cos{u}e^u du + C$$

$$2\int \cos{u}e^u du = e^u \cos{u} + e^u \sin{u} + C$$

$$\int \cos{u}e^u du = \frac{1}{2} \times (e^u \cos{u} + e^u \sin{u}) + C$$

$$\int \cos{u}e^u du = \frac{e^u}{2} \times ( \cos{u}+ \sin{u}) + C$$

#### Intégrale 2 :

$$\int \sin{u}e^u du = e^u \sin{u} - e^u \cos{u} - \int \sin{u}e^u du + C$$

$$2\int \sin{u}e^u du = e^u \sin{u} - e^u \cos{u} + C$$

$$\int \sin{u}e^u du = \frac{1}{2} \times (e^u \sin{u} - e^u \cos{u}) + C$$

$$\int \sin{u}e^u du = \frac{e^u}{2} \times (\sin{u} - \cos{u}) + C$$

#### Regroupement :

$$\int \cos{u}e^u du + i \times \int \sin{u}e^u du = \frac{e^u}{2}(\cos{u}+\sin{u}+i\sin{u}-i\cos{u}) + C$$

$$=\frac{x}{2} \times (\cos{ln{x}}+\sin{ln{x}}+i\sin{ln{x}}-i\cos{ln{x}})+C$$
...
$$\cos{x} = \frac{e^{i\theta}+e^{-i\theta}}{2}$$
...
$$=\frac{x}{2} \times(\frac{e^{i ln{x}}+e^{-i ln{x}}}{2} - i \times \frac{e^{i ln{x}}+e^{-i ln{x}}}{2} + \frac{e^{i ln{x}}-e^{-i ln{x}}}{2i} + i \times \frac{e^{i ln{x}}-e^{-i ln{x}}}{2i})$$

D'abord :

$$=\frac{x}{4} \times(x^i + x^{-i} -ix^i -ix^-i+x^i-x^{-i}+\frac{x^i-x^{-i}}{i})$$

Donne :

$$=\frac{x}{4} \times(2x^i -ix^i - ix^{-i}-ix^i+ix^{-i})$$

Ensuite :

$$=\frac{x}{4} \times(2x^i-2ix^{i})$$
