...
Commentaire : L'ensemble des parties d'un ensemble E a pour cardinal $2^{card E}$, ce qui correspond à la somme des cardinaux des parties à k éléments. Par exemple, nous avons bien pour cet exemple 1+3+3+1=2^3. Pour en savoir plus, [c'est ici](https://keskec.fr/sciences/mathematiques/robin/4073/).
