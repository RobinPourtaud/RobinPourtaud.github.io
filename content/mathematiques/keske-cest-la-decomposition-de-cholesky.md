...
Une matrice $A$ est dite symétrique si $L = ^tL$. C'est à dire que $\\forall i,j \\in \\dim{A}, A\_{i,j} = A\_{j,i}$.
...
$L = \\begin{bmatrix} L\_{1,1} & 0 & 0 \\\\  
L\_{2,1} & L\_{2,2} & 0 \\\\  
L\_{3,1} & L\_{3,2} & L\_{3,3}\\\\  
\\end{bmatrix}$

$A = \\begin{bmatrix} L\_{1,1} & 0 & 0 \\\\ L\_{2,1} & L\_{2,2} & 0 \\\\ L\_{3,1} & L\_{3,2} & L\_{3,3} \\end{bmatrix}\\begin{bmatrix} L\_{1,1} & L\_{2,1} & L\_{3,1} \\\\ 0 & L\_{2,2} & L\_{3,2} \\\\ 0 & 0 & L\_{3,3} \\end{bmatrix}$

$A = \\begin{bmatrix} L\_{1,1}^2 & \* & \* \\\\ L\_{2,1}L\_{1,1} & L\_{2,1}^2 + L\_{2,2}^2& \* \\\\ L\_{3,1}L\_{1,1} & L\_{3,1}L\_{2,1}+L\_{3,2}L\_{2,2} & L\_{3,1}^2 + L\_{3,2}^2+L\_{3,3}^2 \\end{bmatrix}$
...
A étant de taille 2x2, alors : $A = L^tL= \\begin{bmatrix} L\_{1,1}^2 & L\_{1,1}L\_{2,1} \\\\ L\_{2,1}L\_{1,1} & L\_{2,1}^2 + L\_{2,2}^2 \\end{bmatrix}$.
...
 $\\det{A}=\\det{L^tL}=\\det{L}\\times\\det{^tL}=\\det{L}^2=(\\prod\_{i=1}^{dim L}L\_{i,i})^2$
...
1. [https://en.wikipedia.org/wiki/Cholesky\_decomposition](https://en.wikipedia.org/wiki/Cholesky_decomposition)
2. [https://fr.wikipedia.org/wiki/Factorisation\_de\_Cholesky](https://fr.wikipedia.org/wiki/Factorisation_de_Cholesky)
